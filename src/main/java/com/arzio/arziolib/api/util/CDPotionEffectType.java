...
public class CDPotionEffectType {
	...
	public static final PotionEffectType SCUBA = new ModdedPotionEffect(26);
	...
	public static final PotionEffectType ADRENALINE = new ModdedPotionEffect(30);
	public static final PotionEffectType JUGGERNAUT = new ModdedPotionEffect(31);
